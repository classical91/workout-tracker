...
const WorkoutIllus = {
  ...
  "Standing Calf Raise": "https://liftmanual.com/wp-content/uploads/2023/04/standing-calf-raise.jpg",
    ...
    <div style={{minHeight:"100vh",background:T.bg,fontFamily:font,color:T.text,paddingBottom:60}}>
      ...
      <div style={{maxWidth:500,margin:"0 auto",padding:"0 20px"}}>
        ...
        style={{display:'flex',alignItems:'center',justifyContent:'center',gap:'8px',
          margin:'16px auto 0',padding:'12px 24px',borderRadius:'12px',
          background:'rgba(200,146,42,0.12)',border:'1px solid rgba(200,146,42,0.4)',
          color:'#c8922a',textDecoration:'none',fontFamily:font,fontSize:'12px',
